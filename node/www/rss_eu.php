...
/*  
 * $Id: rss_eu.php,v 1.1 2003/09/23 15:33:13 andras Exp $
 * Created for the StreamOnTheFly project (IST-2001-32226)
 * Authors: András Micsik, Máté Pataki, Tamás Kézdi 
 *          at MTA SZTAKI DSD, http://dsd.sztaki.hu
 this is a version which works with latin1 instead of utf-8
*/
...
if($prgId) {
  ...
  $properties["title"]= utf8_decode($prg->get('title'));
  if(empty($properties["title"]))
	 $properties["title"] = 'Untitled';
  $properties["description"]= utf8_decode(($prg->get('abstract') ? $prg->get('abstract') : '  '));
  $properties["dc:language"]= utf8_decode($prg->get2LetterLanguageCode());
  ...
  $properties["description"] = utf8_decode($text);
